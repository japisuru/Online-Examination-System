    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=datetime.datetime(2025, 7, 24, 18, 28, 51, 493250))),
                ('end_time', models.DateTimeField(default=datetime.datetime(2025, 7, 24, 18, 28, 51, 493270))),
