...
urlpatterns = [
    ...
    path('prof/question-bank/', views.question_bank, name='question_bank'),
    path('prof/question/<int:qno>/edit/', views.edit_question, name='edit_question'),
    path('prof/question/<int:qno>/delete/', views.delete_question, name='delete_question'),
